(function (module) {
	...
	gst.ng.application.controller('CreateFixedDepositAccountController', ['$scope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter','$modal', gst.controllers.CreateFixedDepositAccountController]).run(function ($log) {
