(function (module) {
	...
	gst.ng.application.controller('EditShareAccountController', ['$scope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter', gst.controllers.EditShareAccountController]).run(function ($log) {
