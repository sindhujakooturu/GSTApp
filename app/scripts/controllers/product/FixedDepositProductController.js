(function (module) {
	...
	gst.ng.application.controller('FixedDepositProductController', ['$scope', 'ResourceFactory', '$location', gst.controllers.FixedDepositProductController]).run(function ($log) {
