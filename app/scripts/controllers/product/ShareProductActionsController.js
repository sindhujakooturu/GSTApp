(function (module) {
	...
	gst.ng.application.controller('ShareProductActionsController', ['$scope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter', gst.controllers.ShareProductActionsController]).run(function ($log) {
