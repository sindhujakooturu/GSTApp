(function (module) {
	...
	gst.ng.application.controller('CreateChargeController', ['$scope', 'ResourceFactory', '$location', 'dateFilter', '$translate', gst.controllers.CreateChargeController]).run(function ($log) {
