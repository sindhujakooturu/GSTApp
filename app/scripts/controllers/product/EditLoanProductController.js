(function (module) {
	...
	gst.ng.application.controller('EditLoanProductController', ['$scope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter', gst.controllers.EditLoanProductController]).run(function ($log) {
