(function(module) {
	...
	gst.ng.application.controller('ViewRecurringDepositProductController', ['$scope', '$routeParams', '$location', '$anchorScroll' , 'ResourceFactory','$modal', gst.controllers.ViewRecurringDepositProductController]).run(function($log) {
