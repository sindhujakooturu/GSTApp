(function (module) {
	...
	gst.ng.application.controller('CreateFloatingRateController', ['$scope', 'ResourceFactory', '$location', 'dateFilter', '$translate', gst.controllers.CreateFloatingRateController]).run(function ($log) {
