(function (module) {
	...
	gst.ng.application.controller('EditShareProductController', ['$scope', 'ResourceFactory', 'dateFilter', '$location', '$routeParams', gst.controllers.EditShareProductController]).run(function ($log) {
