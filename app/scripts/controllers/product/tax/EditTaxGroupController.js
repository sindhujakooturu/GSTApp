(function (module) {
	...
	gst.ng.application.controller('EditTaxGroupController', ['$scope', 'ResourceFactory', '$routeParams', '$location', 'dateFilter', gst.controllers.EditTaxGroupController]).run(function ($log) {
