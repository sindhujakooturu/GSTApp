(function (module) {
	...
	gst.ng.application.controller('EditRecurringDepositProductController', ['$scope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter','$modal', gst.controllers.EditRecurringDepositProductController]).run(function ($log) {
