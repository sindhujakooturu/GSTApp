(function (module) {
	...
	gst.ng.application.controller('CreateFixedDepositProductController', ['$scope', 'ResourceFactory', '$location', 'dateFilter','$modal', gst.controllers.CreateFixedDepositProductController]).run(function ($log) {
