(function (module) {
	...
	gst.ng.application.controller('CreateStandingInstructionController', ['$scope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter', gst.controllers.CreateStandingInstructionController]).run(function ($log) {
