(function (module) {
	...
	gst.ng.application.controller('EditFinancialActivityMappingController', ['$scope', 'ResourceFactory', '$location','$routeParams', gst.controllers.EditFinancialActivityMappingController]).run(function ($log) {
