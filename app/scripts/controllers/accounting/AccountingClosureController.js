(function (module) {
	...
	gst.ng.application.controller('AccountingClosureController', ['$scope', 'ResourceFactory', '$location', '$translate', '$routeParams', 'dateFilter', gst.controllers.AccountingClosureController]).run(function ($log) {
