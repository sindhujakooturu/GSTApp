(function (module) {
	...
	gst.ng.application.controller('ViewAccountingClosureController', ['$scope', 'ResourceFactory', '$location', '$routeParams', '$modal', gst.controllers.ViewAccountingClosureController]).run(function ($log) {
