(function (module) {
	...
	gst.ng.application.controller('GuarantorController', ['$scope', 'ResourceFactory', '$routeParams', '$location', 'dateFilter', gst.controllers.GuarantorController]).run(function ($log) {
