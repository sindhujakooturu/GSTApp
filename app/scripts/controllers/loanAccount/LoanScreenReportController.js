(function (module) {
	...
	gst.ng.application.controller('LoanScreenReportController', ['$scope', 'ResourceFactory', '$location', '$http', 'API_VERSION', '$routeParams', '$rootScope', '$sce', gst.controllers.LoanScreenReportController]).run(function ($log) {
