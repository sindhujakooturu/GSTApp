(function (module) {
	...
	gst.ng.application.controller('AddLoanCollateralController', ['$scope', 'ResourceFactory', '$routeParams', '$location', gst.controllers.AddLoanCollateralController]).run(function ($log) {
