(function (module) {
	...
	gst.ng.application.controller('NewLoanAccAppController', ['$scope', '$routeParams', 'ResourceFactory', '$location', 'dateFilter', 'UIConfigService', 'WizardHandler', gst.controllers.NewLoanAccAppController]).run(function ($log) {
