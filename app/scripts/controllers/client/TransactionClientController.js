(function (module) {
	...
	gst.ng.application.controller('TransactionClientController', ['$scope', 'ResourceFactory', '$routeParams', '$location', gst.controllers.TransactionClientController]).run(function ($log) {
