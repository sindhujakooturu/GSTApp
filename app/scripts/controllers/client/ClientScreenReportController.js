(function (module) {
	...
	gst.ng.application.controller('ClientScreenReportController', ['$scope', 'ResourceFactory', '$location', '$http', 'API_VERSION', '$routeParams', '$rootScope', '$sce', gst.controllers.ClientScreenReportController]).run(function ($log) {
