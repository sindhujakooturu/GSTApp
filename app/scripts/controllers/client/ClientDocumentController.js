(function (module) {
	...
	gst.ng.application.controller('ClientDocumentController', ['$scope', '$location', '$http', '$routeParams', 'API_VERSION', '$upload', '$rootScope', gst.controllers.ClientDocumentController]).run(function ($log) {
