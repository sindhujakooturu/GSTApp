(function (module) {
	...
	gst.ng.application.controller('CreateSavingAccountController', ['$scope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter', 'WizardHandler', gst.controllers.CreateSavingAccountController]).run(function ($log) {
