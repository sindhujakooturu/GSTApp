(function (module) {
	...
	gst.ng.application.controller('AddNewSavingsChargeController', ['$scope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter', gst.controllers.AddNewSavingsChargeController]).run(function ($log) {
