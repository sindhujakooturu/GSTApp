(function (module) {
	...
	gst.ng.application.controller('AssignSavingsOfficerController', ['$scope', 'ResourceFactory', '$routeParams', '$location', 'dateFilter', gst.controllers.AssignSavingsOfficerController]).run(function ($log) {
