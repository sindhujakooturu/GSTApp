(function (module) {
	...
	gst.ng.application.controller('CreateProvisioningCriteriaController', ['$scope', 'ResourceFactory', '$location', 'dateFilter', '$translate', gst.controllers.CreateProvisioningCriteriaController]).run(function ($log) {
