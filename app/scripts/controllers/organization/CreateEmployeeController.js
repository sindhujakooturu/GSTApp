(function (module) {
	...
	gst.ng.application.controller('CreateEmployeeController', ['$scope', 'ResourceFactory', '$location', 'dateFilter', gst.controllers.CreateEmployeeController]).run(function ($log) {
