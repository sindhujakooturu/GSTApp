(function (module) {
	gst.controllers = _.extend(module, {
		CreatePurchaseController: function (scope, resourceFactory, location, http, dateFilter, API_VERSION, $upload, $rootScope, routeParams, WizardHandler) {
            /*scope.offices = [];
            scope.staffs = [];
...
// end of address
	...
	gst.ng.application.controller('CreatePurchaseController', ['$scope', 'ResourceFactory', '$location', '$http', 'dateFilter', 'API_VERSION', '$upload', '$rootScope', '$routeParams', 'WizardHandler', gst.controllers.CreatePurchaseController]).run(function ($log) {
        $log.info("CreatePurchaseController initialized");
    });
}(gst.controllers || {}));
