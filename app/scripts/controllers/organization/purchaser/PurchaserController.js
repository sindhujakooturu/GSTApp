(function (module) {
	gst.controllers = _.extend(module, {
        PurchaseController: function (scope, resourceFactory, location) {
            /*scope.clients = [];
            scope.actualClients = [];
            scope.searchText = "";
            scope.searchResults = [];
	...
	gst.ng.application.controller('PurchaseController', ['$scope', 'ResourceFactory', '$location', gst.controllers.PurchaseController]).run(function ($log) {
