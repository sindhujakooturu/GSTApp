(function (module) {
	...
	gst.ng.application.controller('CreateOfficeController', ['$scope', 'ResourceFactory', '$location', 'dateFilter', gst.controllers.CreateOfficeController]).run(function ($log) {
