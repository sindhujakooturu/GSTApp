(function (module) {
	...
	gst.ng.application.controller('EditEmployeeController', ['$scope', '$routeParams', 'ResourceFactory', '$location', 'dateFilter', gst.controllers.EditEmployeeController]).run(function ($log) {
