(function (module) {
	...
	gst.ng.application.controller('ViewPaymentTypeController', ['$scope', '$routeParams', 'ResourceFactory', '$location', '$modal', '$route', gst.controllers.ViewPaymentTypeController]).run(function ($log) {
