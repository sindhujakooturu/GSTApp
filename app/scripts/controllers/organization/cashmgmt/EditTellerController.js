(function (module) {
	...
	gst.ng.application.controller('EditTellerController', ['$scope', '$routeParams', 'ResourceFactory', '$location', 'dateFilter', gst.controllers.EditTellerController]).run(function ($log) {
