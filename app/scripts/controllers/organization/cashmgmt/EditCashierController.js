(function (module) {
	...
	gst.ng.application.controller('EditCashierController', ['$scope', '$routeParams', 'ResourceFactory', '$location', 'dateFilter', gst.controllers.EditCashierController]).run(function ($log) {
