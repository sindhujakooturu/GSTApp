(function (module) {
	...
	gst.ng.application.controller('CreateCashierForTellerController', ['$scope', '$routeParams', '$route', '$location', 'dateFilter', 'ResourceFactory', gst.controllers.CreateCashierForTellerController]).run(function ($log) {
