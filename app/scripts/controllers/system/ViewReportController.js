(function (module) {
	...
	gst.ng.application.controller('ViewReportController', ['$scope', '$routeParams', 'ResourceFactory', '$location', '$modal', gst.controllers.ViewReportController]).run(function ($log) {
